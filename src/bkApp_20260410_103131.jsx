  ...
  return (
    <svg viewBox="0 0 260 220" width={s} height={s * 0.846} style={{ display: "block" }}>
      ...
      <g transform="rotate(6, 76, 95)">
        ...
        {happy ? <g><path d="M53 85 Q60 92 67 85" fill="none" stroke="#fdf9f0" strokeWidth="3" strokeLinecap="round"/><path d="M85 85 Q92 92 99 85" fill="none" stroke="#fdf9f0" strokeWidth="3" strokeLinecap="round"/></g> : <g><ellipse cx="60" cy="86" rx="7" ry="6" fill="#fdf9f0"/><ellipse cx="92" cy="86" rx="7" ry="6" fill="#fdf9f0"/><ellipse cx="61" cy="87" rx="4.5" ry="4" fill="#1a1a2a"/><ellipse cx="93" cy="87" rx="4.5" ry="4" fill="#1a1a2a"/><circle cx="63" cy="85" r="1.6" fill="white"/><circle cx="95" cy="85" r="1.6" fill="white"/></g>}
      ...
      <g transform="rotate(-4, 176, 90)">
        ...
        {happy ? <g><path d="M155 87 Q162 94 169 87" fill="none" stroke="#fdf9f0" strokeWidth="3" strokeLinecap="round"/><path d="M183 87 Q190 94 197 87" fill="none" stroke="#fdf9f0" strokeWidth="3" strokeLinecap="round"/></g> : <g><ellipse cx="162" cy="88" rx="7" ry="6" fill="#fdf9f0"/><ellipse cx="190" cy="88" rx="7" ry="6" fill="#fdf9f0"/><ellipse cx="163" cy="89" rx="4.5" ry="4" fill="#1a1a2a"/><ellipse cx="191" cy="89" rx="4.5" ry="4" fill="#1a1a2a"/><circle cx="165" cy="87" r="1.6" fill="white"/><circle cx="193" cy="87" r="1.6" fill="white"/></g>}
  ...
  return (
    <svg viewBox="0 0 390 290" style={{ width:"100%", display:"block", borderRadius: "0 0 20px 20px" }}>
      ...
      {isNight ? (
        ...
        </g> : <circle cx="330" cy="55" r="14" fill="#f8e8c0" opacity="0.6"/>
      ) : (
        // SOL - modo día
        g.sun ? <g>
      ...
      </g> : <circle cx="330" cy="55" r="18" fill="#e8c860" opacity="0.5"/>}
      ...
      <ellipse cx="290" cy="210" rx="140" ry="70" fill={HILL[lvl]} opacity="0.28"/>
...
export default function App() {
  ...
  if (screen === "login") return <g><style>{STYLES}</style><Login onLogin={afterLogin}/></g>;
  if (screen === "onboarding") return <g><style>{STYLES}</style><Onboarding onDone={()=>setScreen("reltest")}/></g>;
  ...
  if (screen === "reltest") return <g><style>{STYLES}</style><SectionErrorBoundary fallback={relTestFallback}><RelTest user={user} onDone={finishTest}/></SectionErrorBoundary></g>;
  if (user && !user?.isGuest && user?.code && !testScores) return <g><style>{STYLES}</style><SectionErrorBoundary fallback={relTestFallback}><RelTest user={user} onDone={finishTest}/></SectionErrorBoundary></g>;
