...
const CONOCE_CATS = {
  infancia:{emoji:"🧸",label:"Infancia",bg:"#f1ecfb",preguntas:["¿Cuál es tu recuerdo más feliz de la infancia?","¿Cómo era tu relación con tu mamá cuando eras pequeño/a?","¿Cómo era tu relación con tu papá cuando eras pequeño/a?","¿Qué te enseñó tu familia sobre el amor?","¿Cuál fue el momento más difícil de tu infancia?","¿Qué te hubiera gustado recibir más de niño/a?"]},
  amor: {emoji:"💕",label:"Amor",bg:"#f7ecff",preguntas:["¿Qué te ayuda a sentirte realmente amado/a?","¿Cuál ha sido tu herida más grande en el amor?","¿Qué te da más miedo en una relación?","¿Qué valoras más de nuestra relación hoy?","¿Hay algo que siempre quisiste decirme y aún no has podido?","¿Qué necesitas de mí que quizá todavía no me has pedido?"]},
  suenos: {emoji:"🌙",label:"Sueños",bg:"#ecebff",preguntas:["¿Qué sueño todavía quieres perseguir?","¿Cómo imaginas tu vida en 10 años?","¿Qué meta has querido lograr pero aún no has intentado?","¿Qué sientes que nos falta vivir juntos?","Si el dinero no fuera un problema, ¿cómo vivirías?","¿Qué legado quieres dejar en el mundo?"]},
  miedos: {emoji:"🫂",label:"Miedos",bg:"#e8f5ec",preguntas:["¿Qué temes más en la vida?","¿Cuándo necesitas más un abrazo?","¿Cuándo te sientes solo/a incluso si estoy contigo?","¿Qué te cuesta más pedir?","¿Qué te cuesta más recibir?","¿Cuál es tu inseguridad más grande y cómo puedo acompañarte?"]},
};

const BURBUJA_SECTIONS = [
  {id:"tipo",icon:"💑",title:"Tipo de relación",sub:"Monogamia, exclusividad y definición",itemBg:"#f5eeff",
    items:[
      {id:"tipo1",q:"¿Qué tipo de relación tienen? ¿Cómo la definirían? (ej: noviazgo, exclusivos, abierta, en proceso)",phA:"Para mí, nuestra relación es...",phB:"Para mí, nuestra relación es..."},
      {id:"tipo2",q:"¿Cuánto espacio personal necesita cada uno?",phA:"Necesito...",phB:"Necesito..."},
      {id:"tipo3",q:"¿Cómo manejan el tiempo por separado con amistades y familia?",phA:"Para mí es importante...",phB:"Para mí es importante..."},
    ]},
  {id:"fidelidad",icon:"🤝",title:"Fidelidad y límites",sub:"Qué cuenta como infidelidad para nosotros",itemBg:"#f3ebff",
    items:[
      {id:"fidel1",q:"¿Qué consideras tú que es infidelidad?",phA:"Para mí, la infidelidad es...",phB:"Para mí, la infidelidad es...",note:"Más allá de lo físico: mensajes, intimidad emocional o coqueteo. No hay respuestas incorrectas."},
      {id:"fidel2",q:"¿Qué necesitas de tu pareja para sentirte seguro/a?",phA:"Para sentirme seguro/a necesito...",phB:"Para sentirme seguro/a necesito..."},
  ...
  {id:"discusion",icon:"⚡",title:"Reglas para discutir",sub:"Cómo manejar conflictos juntos",itemBg:"#ecebff",
    items:[
      {id:"disc1",q:"¿Cuál es tu señal para decir: 'necesito una pausa'?",phA:"Cuando me siento desbordado/a...",phB:"Cuando me siento desbordado/a..."},
      {id:"disc2",q:"¿Qué está fuera de límites en sus discusiones?",phA:"Ej: gritos, sacar temas pasados...",phB:"Ej: insultos, silencio por días..."},
      {id:"disc3",q:"¿Cómo se reconectan después de una pelea?",phA:"Para reconectarme necesito...",phB:"Para reconectarme necesito..."},
      {id:"disc4",q:"¿Cuánto tiempo de pausa les parece sano antes de retomar la conversación?",phA:"Necesito al menos...",phB:"Necesito al menos..."},
    ]},
  {id:"quiero",icon:"✨",title:"Lo que necesito de ti",sub:"Necesidades, deseos y peticiones",itemBg:"#f8efff",
    items:[
      {id:"quiero1",q:"¿Qué necesitas más de tu pareja que aún no has pedido?",phA:"Lo que más necesito es...",phB:"Lo que más necesito es..."},
      {id:"quiero2",q:"¿Cómo prefieres recibir amor?",phA:"Me siento amado/a cuando...",phB:"Me siento amado/a cuando..."},
      {id:"quiero3",q:"¿Qué cosa pequeña podría hacer tu pareja que te haría muy feliz?",phA:"Una cosa pequeña que me haría feliz...",phB:"Una cosa pequeña que me haría feliz..."},
    ]},
  {id:"futuro",icon:"🌱",title:"El futuro",sub:"Planes, metas y sueños compartidos",itemBg:"#e8f5ec",
    items:[
      ...
      {id:"fut2",q:"¿Quieren tener hijos o no? Si sí, ¿cuándo?",phA:"Sobre los hijos, yo siento...",phB:"Sobre los hijos, yo siento..."},
      {id:"fut3",q:"¿Cómo imaginan su hogar ideal?",phA:"Mi hogar ideal es...",phB:"Mi hogar ideal es..."},
    ]},
  {id:"economia",icon:"💰",title:"Dinero y finanzas",sub:"Gastos, ahorro y metas económicas",itemBg:"#f2edff",
    items:[
      {id:"eco1",q:"¿Cómo van a manejar el dinero? ¿Compartido, separado o mixto?",phA:"Para mí, lo ideal es...",phB:"Para mí, lo ideal es...",note:"No hay una respuesta correcta: cuentas separadas, cuenta compartida o ambas. Lo importante es acordarlo juntos."},
      {id:"eco2",q:"¿Qué consideran un 'gasto grande' que debe hablarse primero?",phA:"Para mí, todo gasto mayor a...",phB:"Para mí, todo gasto mayor a..."},
      {id:"eco3",q:"¿Qué metas económicas comparten?",phA:"Una meta que quiero es...",phB:"Una meta que quiero es..."},
      {id:"eco4",q:"¿Cómo manejan deudas o momentos financieros difíciles?",phA:"En esos momentos yo...",phB:"En esos momentos yo..."},
      {id:"eco5",q:"¿Ahorran juntos? ¿Para qué?",phA:"Me gustaría que ahorráramos para...",phB:"Me gustaría que ahorráramos para..."},
    ]},
  {id:"familia",icon:"🏠",title:"Familia y crianza",sub:"Familias de origen, hijos y límites",itemBg:"#f6efff",
    items:[
      {id:"fam1",q:"¿Cuánto espacio debería tener su familia de origen en la relación?",phA:"Para mí, mi familia...",phB:"Para mí, mi familia...",note:"La familia puede ser apoyo o tensión. Pongan límites claros en equipo."},
      {id:"fam2",q:"¿Cómo manejan opiniones o críticas familiares sobre la relación?",phA:"Cuando mi familia opina...",phB:"Cuando mi familia opina..."},
      {id:"fam3",q:"¿Quieren tener hijos? ¿Cuántos y cuándo?",phA:"Sobre los hijos, yo pienso...",phB:"Sobre los hijos, yo pienso..."},
      {id:"fam4",q:"¿Cómo quieren criar a sus hijos? ¿Qué valores no se negocian?",phA:"Para mí, es esencial enseñar...",phB:"Para mí, es esencial enseñar..."},
      {id:"fam5",q:"¿Cómo dividen las responsabilidades del hogar?",phA:"Me siento cómodo/a haciendo...",phB:"Me siento cómodo/a haciendo..."},
      {id:"fam6",q:"¿Tienen mascotas o les gustaría tenerlas?",phA:"Sobre las mascotas...",phB:"Sobre las mascotas..."},
    ]},
];
...
const LOVE_PROMPTS = [
  ...
  { icon:"🌿", idea:"Hoy sonreí al recordar cuando " },
...
function GardenItemIcon({ id, size = 38 }) {
  ...
  const icons = {
    ...
    swallow1: (<svg viewBox="0 0 44 38" width={s} height={s*0.86}>
      {/* Pajarito redondito posado en una rama */}
      {/* Branch */}
    ...
    <div style={{ minHeight: "100vh", background: C.sandL, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "28px 20px", fontFamily: "'Nunito',sans-serif" }}>
      ...
      <div style={{ background: C.white, borderRadius: 24, padding: "22px 20px", width: "100%", maxWidth: 380, boxShadow: `0 4px 0 ${C.border}`, border: `1.5px solid ${C.border}` }}>
        ...
        {tab === "pair" && <>
          ...
          {["Tu correo", pEmail, setPEmail, "tu@email.com", "email"], ["Contraseña", pPass, setPPass, "Mínimo 6 caracteres", "password"]].map(([l, v, fn, ph, t]) => (
            <div key={l}><label style={LBL}>{l}</label><Inp value={v} onChange={fn} placeholder={ph} type={t} style={{ marginBottom: 10 }} /></div>
          ))}
...
function Perfil({ user, bamboo, exDone, messages, burbuja, coupleInfo, onSaveCoupleInfo, onSaveNames, onLogout, testScores, onRetakeTest, onDeleteAccount, gratitud, momentos, onAddGratitud, onEditGratitud, onAddMomento, onEditMomento, conoce, onOpenConocete, onSendMessage, onAddBamboo, diarioEntries, onSaveDiarioEntry }) {
  ...
  return (
    <div style={{ background: C.sandL, minHeight: "100vh", paddingBottom: 90 }}>
      ...
      {/* 3. Consejo del día */}
      <div style={{ margin:"0 14px 12px", background:C.white, borderRadius:18, padding:16, boxShadow:`0 3px 0 ${C.border}`, border:`1.5px solid ${C.border}` }}>
        <div style={{ fontFamily:"'Fredoka One',cursive", fontSize:"1rem", color:C.dark, marginBottom:10 }}>📖 Consejo del día</div>
        <Btn onClick={openTip} variant="sand" style={{ width:"100%", fontSize:"0.86rem" }}>
          {tipRewarded ? "Ver consejo de hoy" : "Ver consejo de hoy +15 bambú 🌿"}
        </Btn>
      ...
      {showTipModal && (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.45)", zIndex:6000, display:"flex", alignItems:"center", justifyContent:"center", padding:"16px" }} onClick={() => setShowTipModal(false)}>
          <div onClick={(e)=>e.stopPropagation()} style={{ width:"100%", maxWidth:420, background:C.white, borderRadius:24, padding:"16px 14px 16px", border:`1.5px solid ${C.border}`, boxShadow:"0 14px 36px rgba(0,0,0,0.25)", maxHeight:"78vh", overflowY:"auto" }}>
            <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:10 }}>
              <div style={{ fontFamily:"'Fredoka One',cursive", fontSize:"1.02rem", color:C.dark }}>📖 Consejo del día</div>
